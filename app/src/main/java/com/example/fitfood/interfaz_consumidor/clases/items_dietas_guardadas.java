...
public class items_dietas_guardadas {
    int imagen;
    int id;
    String nombre;
    String tipo_comida;
    ...
    public items_dietas_guardadas(){

    }

    public items_dietas_guardadas(int imagen, int id, String nombre, String tipo_comida, String tipo_imc, String descripcion) {
        this.imagen = imagen;
        this.id = id;
        this.nombre = nombre;
